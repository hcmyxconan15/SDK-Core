...
namespace Watermelon
{
    ...
    public class AdMobContainer
    {
        ...
        public static readonly string ANDROID_BANNER_CENTER_TEST_ID = "ca-app-pub-3940256099942544/6300978111";
        public static readonly string IOS_BANNER_TEST_ID = "ca-app-pub-3940256099942544/2934735716";
        public static readonly string IOS_BANNER_CENTER_TEST_ID = "ca-app-pub-3940256099942544/2934735716";
        ...
        [SerializeField] string androidBannerCenterID = ANDROID_BANNER_CENTER_TEST_ID;
        public string AndroidBannerCenterID => androidBannerCenterID;
        [SerializeField] string iOSBannerCenterID = IOS_BANNER_CENTER_TEST_ID;
        public string IOSBannerCenterID => iOSBannerCenterID;
        ...
        [SerializeField] BannerPlacementType bannerCenterType = BannerPlacementType.Banner;
        public BannerPlacementType BannerCenterType => bannerCenterType;

        [SerializeField] BannerPosition bannerCenterPosition = BannerPosition.Bottom;
        public BannerPosition BannerCenterPosition => bannerCenterPosition;
