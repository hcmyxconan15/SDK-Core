...
namespace Watermelon
{
    ...
    public class AdsSettings : ScriptableObject
    {
        ...
        [SerializeField] AdProvider bannerCenterType = AdProvider.Dummy;
        public AdProvider BannerCenterType => bannerType;
        ...
        [Group("Privacy")]
        [SerializeField] GameObject gdprPanelPrefab;
        public GameObject GDPRPanelPrefab => gdprPanelPrefab;
        ...
        public bool IsDummyEnabled()
        {
            ...
            if (bannerCenterType == AdProvider.Dummy)
                return true;
