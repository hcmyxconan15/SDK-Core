...
namespace Watermelon
{
    ...
    {
        private SerializedProperty bannerCenterTypeProperty;
        ...
        protected void OnEnable()
        {
            ...
            bannerCenterTypeProperty = serializedObject.FindProperty("bannerCenterType");
        ...
        {
            arrowDownContent = new GUIContent(EditorCustomStyles.GetIcon("icon_triangle_down"));
            arrowUpContent = new GUIContent(EditorCustomStyles.GetIcon("icon_triangle_up"));
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayoutCustom.BeginBoxGroup("Advertisement");

            EditorGUILayout.PropertyField(bannerTypeProperty);
            EditorGUILayout.PropertyField(bannerCenterTypeProperty);
            ...
            EditorGUILayoutCustom.BeginBoxGroup("Privacy");
        ...
        private class AdMobContainer : AdsContainer
        {
            ...
            private const string BANNER_CENTER_TYPE_PROPERTY_PATH = "bannerCenterType";
            private const string BANNER_CENTER_POSITION_PROPERTY_PATH = "bannerCenterPosition";
            private const string ANDROID_BANNER_CENTER_ID_PROPERTY_PATH = "androidBannerCenterID";
            ...
            private const string IOS_BANNER_CENTER_ID_PROPERTY_PATH = "iOSBannerCenterID";
            ...
            private SerializedProperty bannerCenterTypeProperty;
            private SerializedProperty bannerCenterPositionProperty;
            private SerializedProperty androidBannerCenterIdProperty;
            ...
            private SerializedProperty iOSBannerCenterIdProperty;
            ...
            public override void Initialize(SerializedObject serializedObject)
            {
                ...
                bannerCenterTypeProperty = containerProperty.FindPropertyRelative(BANNER_CENTER_TYPE_PROPERTY_PATH);
                bannerCenterPositionProperty = containerProperty.FindPropertyRelative(BANNER_CENTER_POSITION_PROPERTY_PATH);
                androidBannerCenterIdProperty = containerProperty.FindPropertyRelative(ANDROID_BANNER_CENTER_ID_PROPERTY_PATH);
                ...
                iOSBannerCenterIdProperty = containerProperty.FindPropertyRelative(IOS_BANNER_CENTER_ID_PROPERTY_PATH);
            ...
            private void DrawAddUnitsSection()
            {
                ...
                DrawIdProperty(androidBannerCenterIdProperty, Watermelon.AdMobContainer.ANDROID_BANNER_CENTER_TEST_ID);
                DrawIdProperty(iOSBannerCenterIdProperty, Watermelon.AdMobContainer.IOS_BANNER_CENTER_TEST_ID);

                EditorGUILayout.PropertyField(bannerCenterTypeProperty);
                EditorGUILayout.PropertyField(bannerCenterPositionProperty);
                ...
                if (GUILayout.Button("Set test ids", EditorCustomStyles.button))
                {
                    ...
                    androidBannerCenterIdProperty.stringValue = Watermelon.AdMobContainer.ANDROID_BANNER_CENTER_TEST_ID;
                    iOSBannerCenterIdProperty.stringValue = Watermelon.AdMobContainer.IOS_BANNER_CENTER_TEST_ID;
